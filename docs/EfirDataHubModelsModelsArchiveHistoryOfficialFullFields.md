...
**akm_bl_n** | **str** | Рейтинг облигационного займа по национальной шкале - AK&amp;M | [optional] 
**akm_e_n** | **str** | Кредитный рейтинг эмитента по национальной шкале - AK&amp;M | [optional] 
**ask** | **float** | Лучшая цена продажи в валюте торгов | [optional] 
**ask_size** | **int** | Объем по лучшей цене продажи в штуках | [optional] 
**ask_size_total** | **float** | Полный объем предложения | [optional] 
...
**bid_size_total** | **float** | Полный объем спроса | [optional] 
...
**buybackprice** | **float** | Дата обратного выкупа | [optional] 
...
**time_dt** | **datetime** | Время последнего события по инструменту (сделки или котировки) типа DateTime | [optional] 
