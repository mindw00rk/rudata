...
**fcsm_code_matching** | **int** | Соответствие регистрационных номеров выпуска | [optional] 
**inn_matching** | **int** | Соответствие ИНН | [optional] 
**kpp_matching** | **int** | Соответствие КПП | [optional] 
**okpo_matching** | **int** | Соответствие ОКПО | [optional] 
**okved_matching** | **int** | Соответствие ОКВЭД | [optional] 
**reg_code_matching** | **int** | Соответствие ОГРН | [optional] 
